package org.gamemessenger.Architectur.MVC.model.helper;
...
public class NotificationUtils {
    ...
    public void showNotificationMessage(final String title, final String message, final String timeStamp, Intent intent, String imageUrl) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            notificationChannel = new NotificationChannel(Channel_iD, title,
        ...
        showSmallNotification(mBuilder, icon, title, message, timeStamp, resultPendingIntent,notificationChannel);
...
/*
    ...
    private void showSmallNotification(NotificationCompat.Builder mBuilder, int icon, String title, String message,
                                       String timeStamp, PendingIntent resultPendingIntent,NotificationChannel notificationChannel) {
